...
extern unsigned long long pxt4_file_write_iter_total_time, pxt4_file_write_iter_total_count;
extern unsigned long long mm_total_time, mm_total_count;
...
static void __exit pxt4_exit_fs(void)
{
	...
	printk("pxt4_file_write_iter is called %llu times, and the time interval is %lluns\n",
		pxt4_file_write_iter_total_count, pxt4_file_write_iter_total_time);
	printk("balance_dirty_pages_ratelimited is called %llu times, and the time interval is %lluns\n",
		mm_total_count, mm_total_time);
