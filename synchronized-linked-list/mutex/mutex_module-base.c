...
{	
	...
	printk("%s: Mutex linked list insert time: %llu ns, count: %llu\n", 
		__func__, add_to_list_time, add_to_list_count);
	printk("%s: Mutex linked list search time: %llu ns, count: %llu\n", 
		__func__, search_list_time, search_list_count);
	printk("%s: Mutex linked list delete time: %llu ns, count: %llu\n", 
